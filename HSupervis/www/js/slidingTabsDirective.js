    ...
    return {
        ...
        link: function(scope, element, attrs, parent) {
            ...
            var init = function () {
                ...
                var tabItems = '<li ng-repeat="(key, value) in tabs" ng-click="onTabTabbed($event, {{key}});tyu({{key}})" class="slider-slide-tab" ng-bind-html="value"></li>';
            ...
            var setIndicatorPosition = function (currentSlideIndex, targetSlideIndex, position, slideDirection) {
              ...
              if(slideTabs!='undefined' && slideTabs!=null) {
                var targetTab = angular.element(slideTabs[targetSlideIndex]);
              }
